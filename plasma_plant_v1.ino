//  Reach out through me [siddharthansp07@gmail.com] 
#include <AFMotor.h>
#include <Servo.h>
#include <Wire.h>
...
void loop() {
  ...
  // If soil is UNKNOWN, do nothing but blink the LED
  if (strcmp(majorType, "UNKNOWN") == 0) {
    stopMotors();               // make sure motors stay off
    digitalWrite(RELAY_PIN, HIGH); // make sure pump stays off
    return;
  }
